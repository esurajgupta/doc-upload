  ...
  <div class="flex flex-col">
    <div class="flex items-center justify-between px-4 pt-4 shrink-0">
      ...
      <span class="inline-flex items-center gap-2 justify-center w-full py-3">
        <span
          class="font-semibold text-2xl text-blue-900"
        ...
        <li v-for="menu of menus">
          ...
          >
            <li v-for="child of menu.children">
              <router-link
                :to="child.menuUrl === null ? '' : child.menuUrl"
                v-ripple
...
export default {
  ...
  mounted() {
    this.menus = this.menus.map((item) => {
      return { ...item, isActive: this.$route.path === item.menuUrl ? true : false }
    })
  },
  methods: {
    menuListItem() {
      const menuList = [
        // {
        //   menuUrl: '/translanding/myTasks',
        //   menuIcon: 'pi pi-clipboard',
        //   menuName: 'My Tasks',
        //   parentmenuid: null,
        //   isActive: false,
        //   children: []
        // }
        // {
        //   menuUrl: '/translanding/instance',
        //   menuIcon: 'pi pi-clone',
        //   menuName: 'Instance',
        //   parentmenuid: null,
        //   isActive: false,
        //   children: []
      ...
      if (localStorage.getItem('role') === constant.adminUserName) {
        ...
        menuList.push({
          menuUrl: '/translanding/deleteFileHistory',
          menuIcon: 'pi pi-trash',
          menuName: 'Delete File History',
          parentmenuid: null,
          isActive: false,
          children: []
        })
        // menuList.push({
        //   menuUrl: '/translanding/workflowList',
        //   menuIcon: 'pi pi-sitemap',
        //   menuName: 'Running Instances',
        //   parentmenuid: null,
        //   isActive: false,
        //   children: []
        // })
    ...
    handleMenuClick(menu) {
      this.menus = this.menus.map((item) => {
        return { ...item, isActive: menu.menuUrl === item.menuUrl ? true : false }
      })
      this.generateColor()
    }
  }
